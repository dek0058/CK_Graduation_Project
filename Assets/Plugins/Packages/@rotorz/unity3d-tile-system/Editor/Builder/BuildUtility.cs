...
namespace Rotorz.Tile.Editor
{
    ...
    public static class BuildUtility
    {
        ...
        public static void BuildScene()
        {
            ...
            if (!EditorSceneManager.SaveScene(EditorSceneManager.GetActiveScene(), outputPath)) {
        ...
        public static void BuildPrefab(TileSystem system, string dataPath, string prefabPath)
        {
            ...
            try {
                ...
                var newPrefab = PrefabUtility.SaveAsPrefabAssetAndConnect(duplicateTileSystemGO, prefabPath, InteractionMode.AutomatedAction);
