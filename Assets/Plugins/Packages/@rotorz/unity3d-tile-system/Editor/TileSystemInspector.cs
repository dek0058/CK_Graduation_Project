...
namespace Rotorz.Tile.Editor
{
    ...
    internal sealed class TileSystemInspector
    {
        ...
        private void DrawModifyGridSection()
        {
            ...
            if (PrefabUtility.GetPrefabAssetType(tileSystem) == PrefabAssetType.Regular) {
        ...
        private void DrawToolbar()
        {
            ...
            EditorGUI.BeginDisabledGroup(PrefabUtility.GetPrefabAssetType(this.target) == PrefabAssetType.Regular || this.targets.Length != 1);
